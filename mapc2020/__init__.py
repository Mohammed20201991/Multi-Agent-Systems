...
def hint2() -> str:
    return "In the end, it must be an array of bytes, but it's up to you which intermediate representation you want to use.\nRemember that you can use json.dumps(.) to parse a json object to a string."
def hint3() -> str:
    return 'To parse a string to an array of bytes you can use: yourstring.encode("utf-8")'
def hint4() -> str:
